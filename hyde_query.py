...
if __name__ == '__main__':
    ...
    - Provide clear and concise responses based on your knowledge of Red Hat's US Benefits.
    - If the question is not related to Red Hat's US Benefits, politely decline to answer and explain that your expertise is limited to this specific domain.
    - Do not make assumptions or speculate beyond your knowledge base.
    - Maintain a professional and helpful tone.

    Here is some context to consider when answering the question:
    {context}
